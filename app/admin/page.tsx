  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <Link href="/admin/tournaments" className="rounded-3xl border border-white/10 bg-white/5 p-5 hover:bg-white/10">
        ...
        <Link href="/admin/support" className="rounded-3xl border border-white/10 bg-white/5 p-5 hover:bg-white/10">
        ...
        <Link href="/admin/users" className="rounded-3xl border border-white/10 bg-white/5 p-5 hover:bg-white/10">
        ...
        <Link href="/admin/sponsors" className="rounded-3xl border border-white/10 bg-white/5 p-5 hover:bg-white/10">
